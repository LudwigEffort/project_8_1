...
**** TODO Registrazione e autenticazione utente (Login Web API)
 1. [ ] Gli utenti dovrebbero essere in grado di registrare un account con la propria email e password.
...
**** TODO Amministrazione Utenti (Loging Web API)
 1. [ ] L'amministratore degli utenti può creare, modificare, aggiornare qualsiasi profilo utente (eccetto la password).
 2. [ ] L'amministratore degli utenti può accedere a tutte le informazioni degli utenti.
 3. [ ] L'amministratore degli utenti può bloccare o riabilitare qualsiasi utente.
...
**** TODO API RESTful
 1. [ ] Implementare un'API RESTful che espone endpoint per la gestione degli utenti e del laboratorio (operazioni CRUD).
 ...
 3. [ ] L'API dovrebbe seguire i principi RESTful, con URL chiari e significativi.
 4. [ ] Includere i metodi HTTP appropriati (GET, POST, PUT, DELETE) per ciascuna operazione.
**** TODO Persistenza
 1. [ ] La persistenza può essere implementata utilizzando il meccanismo e il formato preferiti.
